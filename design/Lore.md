...
* The Feral, who were once highly intelligent creatures who depended on Antientropic energy to remain sapient. The new monastic order caused their decay into an animalistic state, starved of complexity. Their bodies bear important resources that can be used to produce complexity, but they refuse to share it.
