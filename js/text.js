...
messages = {
    ...
    "ESaint6" : "\"[w]I will try to resist for as long as possible to [c]buy you time, but after I succumb, you will inevitably [w]be marked as the next target.\"",
...
researchexpl = {
    ...
    "Axioms" : "The base effects of each Subdued Soul are interesting, but unimpressive in the long term.\n\nEach Caste can hold a single artificial Axiom, crafted out of at least one Form and one Function, and, optionally, Mutators and Contingencies.\n\nFrom then onwards, each use of a Subdued Soul of that given Caste will instead trigger the Axiom's effects.",
