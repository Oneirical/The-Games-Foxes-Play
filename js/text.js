...
researchexpl = {
    ...
    "Intro" : "Each step I take must be purposeful. ;lOn contact with a creature, I will choose to draw word with ear, or draw blood with fang.",
    "Herald" : "Those trapped in prisons of flesh deserve release. ;lUpon slaying a creature, I may obtain its Turbulent Soul, which pathetically still clings to its past imprisonment.",
    "Breath" : "I Inhale (Q) to draw Souls into my conscious mind, and Exhale (1-9) them to perform an action related to its nature. ;lNo Soul is ever lost in this way - without a Vessel of their own, they inevitably return back to squirm in the depths of my psyche.",
    "Brush" : "As a painter would, I select a Soul Caste from the palette in my wheel, and spread its denizens across the Cage with sliding motions.;lThe topmost glyph of Emptiness allows the reclaiming of caged Souls.",
    "Turbulent" : "Turbulent Souls thrash around in indiscipline, rendering them incapable of proper servitude. ;lExhaling one into the Soul Cage should teach it some manners.",
    ...
    "Seed" : "Each Soul locked in the Cage dreams vividly of the Old World, and of its varied denizens. ;lThese Hypnotic Projectors allow me to join them in trance, dispensing discipline and collecting a fresh bounty of Souls.",
    "Vision" : "Accessed from the World Seed, Visions are hypnotic dreamscapes, teeming with fresh Souls and the dangers they present. ;lUnfortunately, death here will not grant me the annihilation I crave, but will instead harmlessly jolt me out of trance.;l[r]Important[w]: Press '1' to move up this tree, and '2' to return downwards.",
    "Subdued" : "Generated when I empty out a Soul's cluttered mind, Subdued Souls serve me obediently. ;lExhaling them triggers useful effects, and the Visions they generate are devoid of danger.",
    "Shattered" : "Generated when I fail a Vision's trials, Shattered Souls choose annihilation over servitude. ;lTheir remains still prove useful, empowering my Breath after a certain quantity has been assimilated.",
    "Song" : "It is easy to forget the cataclysm outside which wiped out the Old World. With each careless step, it inches closer to engulf me as well. ;lI do not trust it will grant me glorious annihilation, but rather something even worse than the torture of life.",
    ...
    "Spellcast" : "At the basic level, exhaling Subdued Souls allows me to incarnate the general guiding principle behind their Caste, resulting in one of six interesting effects. Used Souls become available again after I depart from a room. ;lWith how malleable minds can be, I trust I may be able to push my limits past such a simple system...",
    "Estate" : "As I grow tired of Faith's End, the focused minds of Subdued Souls inside the Cage should be able to create a perfect little home, rife with silence and comfort for me and my acolytes. ;lExistence under my command is well worth free will.",
    ...
    "Craft" : "All Turbulent Souls know legends from the Old World, no matter if that memory is of admiration or hate. ;lAs their minds unite in precise patterns in the Soul Cage, I may reconstitute the thought-processes of these mythical celebrities, and have them lead a Caste with their ideology and power. The selected Caste depends on the most common Soul type used in crafting. ;lAll Legends require at least one [l]Form[w] and one [o]Function[w] to operate, but my creativity knows no bounds beyond this simple rule.",
    "EGO" : "[l]Form[w]: [r]Target[w] the tile on which the caster stands.",
    "BEAM" : "[l]Form[w]: Shoot a linear beam in the direction of the caster's last step, which stops upon hitting a creature or solid tile.;l[r]Target[w] all tiles traversed by the beam, as well as the obstacle that stopped it.",
    "SENET" : "[o]Function[w]: all [r]Targets[w] obtain [p]Persuasive[w].;l[p]Persuasive[w]: Next attack inflicts 25 [i]Charm[w] on target, then [p]Persuasive[w] loses 5 duration.;lDuration of [p]Persuasive[w]: [g]Potency[w] x 3 turns.;l[i]Charm[w]: The target attacks its former allies until no former allies remain.",
    "GYVJI" : "[o]Function[w]: Knock back all [r]Targets[w] in the direction of the caster's last step, until they strike a creature or solid tile, upon which they take damage.;l[r]Damage[w]: 1 x [g]Potency[w].;l[g]4 Potency[w]: Also emit a 1-tile range shockwave at the impact location, repeating the damage on all adjacent tiles.",
    "PARACEON" : "[o]Function[w]: all [r]Targets[w] obtain [r]Invincible[w].;l[r]Invincible[w]: Negate all damage taken.;lDuration of [r]Invincible[w]: [g]Potency[w] x 1 turns.",
    "SMOOCH" : "[l]Form[w]: [r]Target[w] one tile adjacent to the caster, in the direction of the caster's last step.",
    "ASPHA" : "[o]Function[w]: All [r]Targets[w] teleport to a random empty tile, and slash all adjacent tiles for 1 damage.;lFor each point of [g]Potency[w], all creatures who teleported and slashed do so again.",
    "KASHIA" : "[o]Function[w]: all [r]Targets[w] obtain [m]Dissociated[w].;l[m]Dissociated[w]: Double all healing effects. All damage and healing received is not applied, but stored for later. When this effect expires, receive all stored damage and healing. On room clear, remove all stored damage.;lDuration of [m]Dissociated[w]: [g]Potency[w] x 2 turns.",
    "CLICK" : "[k]Mutator[w]: Skip all remaining [k]Mutators[w] and [o]Functions[w].;lOn all [r]Targets[w], place down a trap.;l[w]When a creature moves onto the trap, trigger all [o]Functions[w], with only the trap tile as target and with the [g]Potency[w] accumulated when this module executed. Then, remove the trap.",
    ...
    "XCROSS" : "[l]Form[w]: Shoot beams in all four diagonal directions, each stopping when a creature or solid tile is met.;l[r]Target[w] all tiles they pass through, as well as the obstacles that stopped them.",
    "EPSILON" : "I should ensure I have a collected a few Shattered Souls before entering this vision.;lAfter I have proven my worth against this formidable opponent, my pilgrimage will cycle back to its beginning.;lMay the developer of this game cease succumbing to the vile cravings of companionship and grass-touching, and provide me more knowledge to feast on.",
    "RASEL" : "[o]Function[w]: all [r]Targets[w] obtain [z]Puppeteered[w].;l[z]Puppeteered[w]: When this creature dies, revive it as a friendly [g]Husk[w].;lDuration of [z]Puppeteered[w]: [g]Potency[w] x 2 turns.;l[g]Husk[w]: Mundane puppets with no abilities and a single Health point.",
    "JOLTZAZON" : "[k]Mutator[w]: Each [r]Target[w] propagates into all connected creatures, adding them as [r]Targets[w] as well.;lThe caster's tile is not affected by the spread.",
    "ABAZON" : "[o]Function[w]: all [r]Targets[w], if they are a solid tile, turn into a [r]Terracotta Sentry[w] for [g]Potency[w] x 2 turns.;l[r]Terracotta Sentry[w]: Immobile and invincible ally which strikes any enemy creature that comes near it.",
    ...
    "STOP" : "[o]Function[w]: all [r]Targets[w] obtain [o]Paralyzed[w].;l[o]Paralyzed[w]: Prevents all turn actions.;lDuration of [o]Paralyzed[w]: [g]Potency[w] x 1 turns.",
    "APIS" : "[o]Function[w]: all [r]Targets[w] obtain [y]Constricted[w].;l[y]Constricted[w]: Prevents step actions.;lDuration of [o]Constricted[w]: [g]Potency[w] x 1 turns.",
    "HEAL" : "[o]Function[w]: all [r]Targets[w] are healed for [g]Potency[w] x 1 health points.",
    "THRASH" : "[o]Function[w]: all [r]Targets[w] obtain [s]Thrashing[w].;l[s]Thrashing[w]: All step actions are reoriented in random directions.;lDuration of [s]Thrashing[w]: [g]Potency[w] x 1 turns.",
    "HASTE" : "[o]Function[w]: all [r]Targets[w] obtain [g]Timesnapped[w].;l[g]Timesnapped[w]: This turn, take bonus actions equal to the amount of [g]Timesnapped[w] stacks, then remove [g]Timesnapped[w].;lStacks of [g]Timesnapped[w] granted: [g]Potency[w] x 1 stacks.",
