...
description = {
    ...
    // Tiles
    "Floor" : "A perfectly smooth surface of black stone, its maddeningly complex glyphs encrusted with decades of accumulated dust. Only an insane soul would dare try to decipher their meaning, for they have been carved by nothing else but the natural force of Negentropy, constantly forcing order where there is chaos, and creation where there is destruction.",
...
soulabi = {
    ...
    "ZAINT" : "ORIGIN OF ALL - Overrides the Saintly caste. When activated, incite surrender from all enemies in the room, then permanently remove Zaint from your inventory.",
    "RASEL" : "EXTENSION OF WILL - Overrides the Vile caste. When activated, for the next 5 turns, become empowered with Reaping, reviving all targets you slay as friendly 1 HP Husks.",
