...
messages = {
    ...
    "FluffyExplain12" : "\"However, Fluffy's plan B does involve the use of a... very well-researched and mass-produced blueprint, after which your companion shall be modelled, and recognize as nothing else than their very identity.\"",
    "FluffyExplain13" : "\"Now, please divert your body away from my dazzling, entrancing embrace, and begin forming your Harmonic Field.\"",
...
description = {
    ...
    "Tinker" : "They thought they could stop the cyclical collapse of the Old World. Those who survived the Antientropic Reactor's explosion thrash in the ruins of their laboratories, cursing themselves for their failure.",
    ...
    "White" : "The fragments of the Antientropic Reactor bear strange thermodynamic properties - many of which hold particular interest to Epsilon, who highly values mass-production in exchange for very few resources. Translocating some of the creation-favouring flux from this battery results in impressive effects, though the over-complexification effect makes long-term exposure risky. One would preferably not want their missile launcher factories to reorient towards production of quantum rubber duckies.",
    ...
    // Tiles
    "Floor" : "A perfectly smooth surface of black stone, its maddeningly complex glyphs encrusted with decades of accumulated dust. Only an insane soul would dare try to decipher their meaning, for they have been carved by nothing else but the natural force of Antientropy, constantly forcing order where there is chaos, and creation where there is destruction.",
    ...
    "Barrier" : "The Saints thought they'd be safe from the end times, locked behind the most expensive and durable materials the Antientropic Reactor could engineer. They were dead wrong.",
...
souldesc = {
    "SOULLESS" : "An abomination issued from Sugcha' engineering, inhabited by a soul absent from any of the six spiritual castes. Instead, Terminal hungers for the souls of others, forging its own personality out of them. When the truth got out, some citizens opposed the Vessel's creation. Their souls made for fine fuel powering the Antientropic Reactor.",
    "TAINTED" : "A swirling mass of spiritual sewage, its energy sapped by the Antientropic Reactor's spirit-crushers.",
