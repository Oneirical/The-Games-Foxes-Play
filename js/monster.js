            ...
            if (this.offsetX != 0 || this.offsetY != 0){
                ...
                if (player === this){
                    ...
                    if (this.offsetX == this.originalOffsetX && this.offsetY == this.originalOffsetY){
                        ...
                        if (this.tile instanceof CageContainer && world.cage.slots[this.tile.x-world.cageCorner[0]][this.tile.y-world.cageCorner[1]].id != "EMPTY") universe.passDown(world.depth+1, this.tile.x, this.tile.y);
                    }
                }
